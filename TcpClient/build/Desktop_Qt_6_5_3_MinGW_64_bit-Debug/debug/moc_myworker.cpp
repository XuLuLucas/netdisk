...
Q_CONSTINIT static const qt_meta_stringdata_CLASSmyWorkerENDCLASS_t qt_meta_stringdata_CLASSmyWorkerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 11),  // "downloadSuc"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 9),  // "m_strPath"
        QT_MOC_LITERAL(32, 14),  // "downloadfailed"
        QT_MOC_LITERAL(47, 6),  // "reason"
        QT_MOC_LITERAL(54, 7)   // "recvMsg"
    },
    "myWorker",
    "downloadSuc",
    "",
...
void myWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->downloadSuc((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->downloadfailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (myWorker::*)(QString );
            if (_t _q_method = &myWorker::downloadSuc; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (myWorker::*)(QString , QString );
            if (_t _q_method = &myWorker::downloadfailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void myWorker::downloadSuc(QString _t1)
{
...
// SIGNAL 1
void myWorker::downloadfailed(QString _t1, QString _t2)
{
