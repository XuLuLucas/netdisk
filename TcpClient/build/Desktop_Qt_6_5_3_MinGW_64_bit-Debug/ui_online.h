...
public:
    ...
    void setupUi(QWidget *Online)
    {
        ...
        addFriend_pd = new QPushButton(Online);
        addFriend_pd->setObjectName("addFriend_pd");
        QFont font1;
        font1.setPointSize(22);
        addFriend_pd->setFont(font1);

        verticalLayout->addWidget(addFriend_pd);
    ...
    void retranslateUi(QWidget *Online)
    {
        ...
        addFriend_pd->setText(QCoreApplication::translate("Online", "\345\212\240\345\245\275\345\217\213", nullptr));
    } // retranslateUi
